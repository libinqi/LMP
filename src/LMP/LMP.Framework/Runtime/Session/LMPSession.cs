...
namespace LMP.Runtime.Session
{
    /// <summary>
    /// Implements ILMPSession to get session informations from ASP.NET Identity framework.
    /// </summary>
    public class LMPSession : IAbpSession, ISingletonDependency
    {
        public long? UserId
        {
            get
        ...
        /// Constructor.
        /// </summary>
        public LMPSession(IMultiTenancyConfig multiTenancy)
        {
