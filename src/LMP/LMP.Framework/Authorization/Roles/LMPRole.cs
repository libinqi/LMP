...
namespace LMP.Authorization.Roles
{
    ...
    /// </remarks>
    [Table("LMPRoles")]
    public class LMPRole<TTenant, TUser> : AuditedEntity<int, TUser>, IRole<int>, IMayHaveTenant<TTenant, TUser>
        ...
        where TTenant : LMPTenant<TTenant, TUser>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="LMPRole{TTenant,TUser}"/> object.
        /// </summary>
        public LMPRole()
        {
        ...
        public LMPRole(int? tenantId, string displayName)
            : this()
        {
            TenantId = tenantId;
        ...
        /// <param name="displayName">Display name of the role</param>
        public LMPRole(int? tenantId, string name, string displayName)
