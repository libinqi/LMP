...
namespace LMP.Authorization.Roles
{
    ...
    /// </summary>
    public abstract class LMPRoleManager<TTenant, TRole, TUser> : RoleManager<TRole, int>, ITransientDependency
        ...
        where TUser : LMPUser<TTenant, TUser>
    {
        ...
        protected LMPRoleManager(
            LMPRoleStore<TTenant, TRole, TUser> store, 
