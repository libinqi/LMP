(function () {
    ...
    angular.module('app').controller(controllerId, [
        'abp.services.questionsystem.question', '$modal',
        function (questionService, $modal) {
            ...
            vm.getQuestionCountText = function () {
                return abp.utils.formatString(vm.localize('QuestionPage'), vm.questions.length, vm.totalQuestionCount);
            };
        }
    ]);
})();